...
void testNou() {
	DO d(cresc);
	assert(d.multimeaCheilor().size() == 0);
	d.adauga(10, 3);
	assert(d.multimeaCheilor().size() == 1 && d.multimeaCheilor()[0] == 10);
	d.sterge(10);
	assert(d.multimeaCheilor().size() == 0);
	d.adauga(3, 5); d.adauga(5, 4); d.adauga(9, 2); d.adauga(2, 5); d.adauga(1, 4);
	auto v = d.multimeaCheilor();
	assert(v.size() == 5);
	assert(v[0] == 1 && v[1] == 2 && v[2] == 3 && v[3] == 5 && v[4] == 9);
	assert(d.sterge(5)==4);
	v = d.multimeaCheilor();
	assert(v.size() == 4);
	assert(v[0] == 1 && v[1] == 2 && v[2] == 3 && v[3] == 9);

	DO d1(desc);
	assert(d1.multimeaCheilor().size() == 0);
	d1.adauga(4, 5);
	d1.adauga(9, 19); d1.adauga(1, 4);
	d1.adauga(2, 190);
	v = d1.multimeaCheilor();
	assert(v.size() == 4);
	assert(v[0] == 9 && v[1] == 4 && v[2] == 2 && v[3] == 1);
	d1.sterge(2); d1.sterge(4); d1.sterge(1); d1.sterge(9);
	assert(d1.multimeaCheilor().size() == 0);
} 
