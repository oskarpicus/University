...
abstract class AbstractDBRepository<ID extends Serializable, E extends Entity<ID>> implements Repository<ID,E> {
    ...
    protected AbstractDBRepository(Validator<ID, E> validator) {
