...
class UI:
    ...
    def __chooseFile(self):
        self.__chosenFilename = askopenfilename()
        self.__clearTextBox()
        self.__textBox.insert(END, Constants.SELECTED_MESSAGE+self.__chosenFilename)

    def __compute(self):
        self.__clearTextBox()
        self.__textBox.insert(END, Constants.RESULT_MESSAGE + self.__getSolutionFilename())
        ga = GA(self.__chosenFilename, Constants.Parameters)
    ...
    def __getSolutionFilename(self):
        ...
        """
        words = self.__chosenFilename.split(".")
